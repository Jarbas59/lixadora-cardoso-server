...
class Conteudo(models.Model):
    ...
    descricao_1 = models.TextField(null=True, blank=True, help_text="Descrição mais longa")
    descricao_2 = models.CharField(max_length=200, null=True, blank=True, help_text="Descrição mais curta até 200 caracteres")
